...
<style>
  ...
  @media (max-width:768px) {{
    /* 아래에서 120px 위에, 좌·우 나란히 */
    .legend {{bottom:120px; top:auto; left:2%;  width:46%; font-size:11px; line-height:1.45;}}
    .promo  {{bottom:120px; top:auto; right:2%; width:42%; font-size:13px; line-height:1.45;}}
